        ...
        <div className="bg-[#f8fafc] min-h-screen font-sans relative">
            ...
            <div className="max-w-7xl mx-auto px-6 pb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20">
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{ background: 'oklch(0.5 0.15 260.18)', borderRadius: '0 24px 0 70px' }}
                        />
                        <h3 className="text-2xl font-bold text-gray-900 mb-3 flex items-center gap-4">
                            <span className="w-12 h-12 rounded-xl bg-[oklch(0.5_0.15_260.18)]/10 text-[oklch(0.5_0.15_260.18)] flex items-center justify-center shadow-sm">
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                            </span>
                            Our Mission
                        </h3>
                        <p className="text-[oklch(0.5_0.15_260.18)] text-sm font-semibold uppercase tracking-[0.15em] mb-4 relative z-10">Engineering Excellence. Delivering Outcomes.</p>
                    ...
                    >
                        ...
                        <p className="text-[oklch(0.5_0.15_260.18)] text-sm font-semibold uppercase tracking-[0.15em] mb-4 relative z-10">Bridging Ambition & Technical Execution.</p>
                        <p className="text-gray-600 leading-relaxed text-base relative z-10 font-medium">
                ...
                <div className="mb-20">
                    ...
                    >
                        <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-[oklch(0.5_0.15_260.18)]/[0.03] border border-gray-100 flex flex-col items-center justify-center text-center hover:-translate-y-2 transition-transform duration-500">
                            <span className="text-3xl font-black text-[oklch(0.5_0.15_260.18)] mb-2">99.9%</span>
                            <span className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em]">Uptime Engineered</span>
                        </div>
                        <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-[oklch(0.5_0.15_260.18)]/[0.03] border border-gray-100 flex flex-col items-center justify-center text-center hover:-translate-y-2 transition-transform duration-500">
                            <span className="text-3xl font-black text-[oklch(0.5_0.15_260.18)] mb-2">50+</span>
                            <span className="text-xs font-bold text-gray-400 uppercase tracking-[0.2em]">Global Clients</span>
                        </div>
                        <div className="bg-white p-8 rounded-[2rem] shadow-xl shadow-[oklch(0.5_0.15_260.18)]/[0.03] border border-gray-100 flex flex-col items-center justify-center text-center hover:-translate-y-2 transition-transform duration-500">
                            <span className="text-3xl font-black text-[oklch(0.5_0.15_260.18)] mb-2">250+</span>
